    ...
    <div className="fixed bottom-6 right-6 z-[99999] flex flex-col gap-2 max-w-sm pointer-events-none select-none">
      {toasts.map((item) => {
        ...
        return (
          <div
            key={item.id}
            className={`p-3.5 rounded-xl shadow-2xl border text-xs pointer-events-auto flex items-start gap-2.5 animate-in fade-in slide-in-from-bottom-3 duration-200 ${
              isSuccess
